...
// INSERT YOUR CODE HERE
let replace = document.getElementById("duration-button");
function changeDuration(){
  let text = document.getElementById("duration-text");
  let new_time = prompt("Enter your number");
  text.innerHTML = new_time;
  duration = new_time;
  recalculate()}
replace.addEventListener("click",changeDuration);